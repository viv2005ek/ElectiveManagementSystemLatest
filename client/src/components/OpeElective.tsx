...
const OpenElective: React.FC<OpenElectiveProps> = ({ electives, onRegister }) => {
        ...
        <div className="flex flex-col items-center w-full p-4">
            ...
            <div className="w-full max-w-4xl">
                <div className="grid grid-cols-12 bg-[#df6939] text-white p-3 rounded-t-lg shadow-sm">
                    ...
                    <div className="col-span-3 font-semibold text-center">Course Code</div>
                ...
                {electives.map((elective, index) => (
                    ...
                    <ElectiveItem
                        ...
                        isDisabled={selectedElective !== null && selectedElective !== index + 1}
            ...
            <button
                className={`mt-6 px-8 py-3 rounded-full bg-[#df6939] text-white font-bold shadow-lg transform transition-all duration-200 ${
                    selectedElective === null ? "opacity-50 cursor-not-allowed" : "hover:bg-[#c95e31]"
                }`}
