...
export default function SingleSelectMenuAlternate<T extends Identifiable>({
  label,
  items,
  selected,
  setSelected,
  ...
  const { refs, floatingStyles } = useFloating({
    ...
    middleware: [offset(4), flip(), shift()], // Flip if needed
  });
        ...
        <div className="relative mt-1.5">
          ...
          {open && (
            <ListboxOptions
              ...
              style={floatingStyles} // Dynamically position dropdown
