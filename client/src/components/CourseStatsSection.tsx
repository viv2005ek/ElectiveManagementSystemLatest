    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        ...
        {courseBuckets.length > 0 && (
          <div className="mt-6">
            <h4 className="text-md font-medium text-gray-700 mb-3">Course Buckets</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="font-medium text-purple-900">{bucket.name}</h4>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-100">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-medium text-yellow-900">Pending Allotments</h4>
                </div>
