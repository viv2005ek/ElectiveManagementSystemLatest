...
const ManageOEPage: React.FC = () => {
    ...
    const handleElectiveChange = (elective: { name: string; courseCode: string }) => {
        ...
        console.log(`Changed elective to: ${elective.name} (${elective.courseCode})`);
    };
    ...
    <h2 className="text-xl font-bold mb-4 text-center text-[#000000]">Elective History</h2>
