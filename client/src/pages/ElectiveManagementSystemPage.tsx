    ...
    <MainLayout>
      ...
      >
        <div className="flex items-center justify-center min-h-screen bg-cover bg-center">
          <div className="w-[490px] max-w-full bg-white/20  backdrop-blur-lg rounded-lg shadow-lg border-2 border-[#fca68d]">
            <div className="p-6">
              <h1 className="text-2xl font-bold text-center">
                Elective Management System
              </h1>
            </div>
            <div className="h-[2px] bg-[#fca68d]"></div>
            <div className="p-6 space-y-4">
              <button
                ...
                onClick={handleClickOE}
              >
                Select an Open Elective
              </button>
              <button
                className="w-full bg-[#FFE6e6] bg-opacity-50 rounded-lg shadow p-4 text-center font-medium hover:bg-[#df6939] hover:text-white transition"
                onClick={handleClickMOE}
              >
                Manage Elective
              </button>
            </div>
