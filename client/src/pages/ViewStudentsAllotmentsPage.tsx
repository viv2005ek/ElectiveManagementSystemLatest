          ...
          <div className="mt-6 space-y-8">
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-4 py-5 sm:px-6 bg-orange-50 border-b border-orange-100">
                <h2 className="text-lg font-medium text-gray-900">Standalone Course Allotments</h2>
                        ...
                        <tr key={allotment.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              allotment.allotmentStatus === AllotmentStatus.Confirmed 
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-4 py-5 sm:px-6 bg-orange-50 border-b border-orange-100">
                <h2 className="text-lg font-medium text-gray-900">Bucket Course Allotments</h2>
                <p className="mt-1 text-sm text-gray-500">
